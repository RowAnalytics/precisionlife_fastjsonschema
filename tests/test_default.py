...
@pytest.mark.parametrize('value, expected', [
    (None, JsonSchemaValidationException('must be object, but is a: NoneType', value='{data}', _rendered_path='data', definition='{definition}', rule='type')),
    ({}, {'a': '', 'b': 42, 'c': {}, 'd': []}),
...
@pytest.mark.parametrize('value, expected', [
    (None, JsonSchemaValidationException('must be array, but is a: NoneType', value='{data}', _rendered_path='data', definition='{definition}', rule='type')),
    ([], ['', 42]),
    (['abc'], ['abc', 42]),
    (['abc', 123], ['abc', 123]),
])
