...
@pytest.mark.parametrize('value, expected', [
    ...
    ({ 'taggedType': { '$tagInvalid': 'str', 'value': 1 }}, JsonSchemaValidationException('tag fields [\'$tagInvalid\'] present, but not accepted by any schema', value=None, _rendered_path='data.taggedType<$tagInvalid>', definition=None, rule='unknownTags')),
    ...
    ({ 'discriminatedType': { 'kind': 1, 'value': 1 }}, JsonSchemaValidationException('discriminator fields [\'kind\'] present, but not accepted by any schema', value=None, _rendered_path='data.discriminatedType<kind=1>', definition=None, rule='badDiscriminators')),
    ({ 'discriminatedType': { 'kind': 'invalid', 'value': 1 }}, JsonSchemaValidationException('discriminator fields [\'kind\'] present, but not accepted by any schema', value=None, _rendered_path='data.discriminatedType<kind=invalid>', definition=None, rule='badDiscriminators')),
