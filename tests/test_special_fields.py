...
@pytest.mark.parametrize('value, expected', [
    ...
    ({ 'taggedType': { '$tagOne': 'str' }}, JsonSchemaException('data.taggedType<$tagOne>.$tagOne must be number', value=None, name=None, definition=None, rule='type')),
    ({ 'taggedType': { '$tagOne': 'str', 'value': 1 }}, JsonSchemaException('data.taggedType<$tagOne>.$tagOne must be number', value=None, name=None, definition=None, rule='type')),
    ...
    ({ 'taggedType': { '$tagOne': 1, 'value': 'str' }}, JsonSchemaException('data.taggedType<$tagOne>.value must be number', value=None, name=None, definition=None, rule='type')),
    ...
    ({ 'discriminatedType': { 'kind': 'one', 'value': 'str' }}, JsonSchemaException('data.discriminatedType<kind=one>.value must be number', value=None, name=None, definition=None, rule='type')),

    ({ 'namedTypeArray': [{ 'name': 'one', 'content': { 'value': 1 }}, { 'name': 'two', 'content': 'str' }, { 'name': 'three', 'content': { 'value': 1 }}]}, JsonSchemaException('data.namedTypeArray[1]<name=two>.content must be object', value=None, name=None, definition=None, rule='type')),
    ({ 'namedTypeArray': [{ 'name': 'one', 'content': { 'value': 1 }}, { 'name': 'two', 'content': { 'value': 'str' } }, { 'name': 'three', 'content': { 'value': 1 }}]}, JsonSchemaException('data.namedTypeArray[1]<name=two>.content.value must be number', value=None, name=None, definition=None, rule='type')),
])
